...
const tutorialSteps=[
  ...
  },
  {
    ...
    text:'الحركات الشهرية تسهّل تسجيل البنود التي تتكرر كل شهر، مثل الراتب والإيجار والاشتراكات. عند الضغط على «إضافة بند» وحفظه، يُحفظ كقالب شهري فقط ولا يُضاف إلى كشف الحركات الفعلي.'
  },
  {
    page:'monthly',
    selector:'#monthly .monthlyActions .save',
    title:'أضف الحركات الشهرية عندما تريد',
    text:'لن تتحول البنود الشهرية إلى حركات فعلية إلا عندما تضغط «إضافة الحركات الآن». بعدها تختار التاريخ وتراجع البنود قبل إضافتها، لتنجز حركات الشهر بسرعة من دون إدخالها واحدةً واحدة.'
  },
  {
    page:'rates',
...
window.startWafferliTutorial=function(){
  if(tutorialActive)return;
